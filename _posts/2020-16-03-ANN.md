...
<hr>  
<br>  
 Ta tính tổng các tích vô hướng (sum of products) của 2 vector input X và trọng số w. Sau đó áp dụng activation function ![](http://latex.codecogs.com/gif.latex?%5Cphi%28x%29) để được đầu ra của lớp này.<br>  
