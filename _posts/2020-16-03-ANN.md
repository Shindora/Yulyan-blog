...
<hr>  
<br>  
 Ta tính tổng các tích vô hướng (sum of products) của 2 vector input X và trọng số w. Sau đó áp dụng activation function <img src="http://www.sciweavers.org/tex2img.php?eq=%5Cphi%28x%29&bc=White&fc=Black&im=bmp&fs=12&ff=arev&edit=0" align="center" border="0" alt="\phi(x)" width="" height="" /> để được đầu ra của lớp này.<br>  
