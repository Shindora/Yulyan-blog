...
<hr>  
<br>  
 Ta tính tổng các tích vô hướng (sum of products) của 2 vector input X và trọng số w. Sau đó áp dụng activation function ![](http://www.sciweavers.org/upload/Tex2Img_1584501708/render.png) để được đầu ra của lớp này.<br>  
