...
**Stochastic Gradient Descent**
 Giả sử: ta có bộ dữ liệu với 8 dòng, đưa vào neural network, tính cost function.
...
Ở bước 5 phần trước, mình có đề cập đến thuật toán lan truyền ngược (**Back-propagation**). Đó là gì?
 ...
 ![](https://raw.githubusercontent.com/Shindora/Yulyan-blog/gh-pages/assets/ann/BP.png)
 Có một kiến thức mà mình chưa đề cập tới là thiên vị (**bias**), mọi người có thể xem tại  [đây](https://medium.com/deeper-learning/glossary-of-deep-learning-bias-cf49d9c895e2).
 <br>
 **4 phương trình cốt lõi của back-propagation**
 ...
 Mục tiêu là tính được đạo hàm từng phần ![](http://www.sciweavers.org/upload/Tex2Img_1584526024/render.png) và ![](http://www.sciweavers.org/upload/Tex2Img_1584526071/render.png).
 <br>
 Trước khi tính 2 thứ đó, ta có thêm  1 thành phần phụ ![](http://www.sciweavers.org/upload/Tex2Img_1584526213/render.png), lỗi (error) trong neuron j của lớp thứ l.
 Cái này dẫn đến một số thay đổi nhỏ ![](http://www.sciweavers.org/upload/Tex2Img_1584526415/render.png) , đầu ra thay vì ![http://www.sciweavers.org/upload/Tex2Img_1584526499/render.png](http://www.sciweavers.org/upload/Tex2Img_1584526499/render.png) sẽ thành ![](http://www.sciweavers.org/upload/Tex2Img_1584526560/render.png). Cost function sẽ thay đổi một lượng ![](http://www.sciweavers.org/upload/Tex2Img_1584526764/render.png).
\begin{eqnarray} 
