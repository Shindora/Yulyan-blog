...
## 6.Stochastic Gradient Descent (SGD) <a name="5"></a>  
 Gradient sẽ cho kết quả tốt nếu biểu diễn đồ thị có dáng chữ U (xem phần 5). Nhưng trong thực tế sẽ không như vậy, vì xảy ra hiện tượng local minimum và global minimum.
 <hr>
<div class="imgcap">
<div >
