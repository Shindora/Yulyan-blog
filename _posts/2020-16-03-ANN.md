...
## 1.Neuron <a name="neuron"></a>  
 ...
 ![Hình. Mô hình Neural Network đơn giản](https://raw.githubusercontent.com/Shindora/Yulyan-blog/gh-pages/image_data/2020-17-03-simpleNN.png)
 ...
 Nó lan truyền qua khớp thần kinh hay synapes (những mũi tên màu xanh), qua hidden layers rồi cho ra giá trị output.
Sự khác biệt chính giữa neural sinh học và nhân tạo là mức độ kiểm soát giá trị đầu vào và các biến độc lập.Con người ta không thế nhận biết được mức độ hôi thối, tiếng vang bên tai hay sự tồi tệ khi rớt môn...  
