...
![](http://www.sciweavers.org/upload/Tex2Img_1584531160/render.png)
 <br>
**Building an simple ANN yourself**: [source](https://github.com/Shindora/Deep-Learning/blob/master/BuildingCNN.py)<br>
**Contact**:tuanvi1792k@gmail.com<br>
**TÀI LIỆU THAM KHẢO**<br>
* 1. Neural network and deep learning [ Michael Nielsen ](http://neuralnetworksanddeeplearning.com/index.html)<br>
* 2. Hình ảnh và cách phân bố nội dung: [Superdatascience](https://www.superdatascience.com/blogs/the-ultimate-guide-to-artificial-neural-networks-ann)<br>
* 3. By Xavier Glorot et al., 2011 [ Deep sparse rectifier neural networks](http://proceedings.mlr.press/v15/glorot11a/glorot11a.pdf)<br>
* 4. Andrew Trask, 2015 [A Neural Network in 13 lines of Python (Part 2 – Gradient Descent)](A Neural Network in 13 lines of Python (Part 2 – Gradient Descent))
