...
<div class="thecap">Hình ảnh Neural Network. <br><br> (Nguồn: <a href="http://cs231n.github.io/convolutional-networks/">CS231n Convolutional Neural Networks for Visual Recognition</a>)</div>
</div>
<hr>  
